...
@section('content')
          ...
          <div class="main-content">
                ...
                <div class="md:flex block items-center justify-between mb-6 mt-[2rem]  page-header-breadcrumb">
                  <div class="my-auto">
                    <h5 class="page-title text-[1.3125rem] font-medium text-defaulttextcolor mb-0">barang</h5>
                    <nav>
                      <ol class="flex items-center whitespace-nowrap min-w-0">
                        <li class="text-[12px]"> <a class="flex items-center text-primary hover:text-primary"
                            href="javascript:void(0);"> barang <i
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="xl:col-span-12 col-span-12">
                        <div class="box custom-box">
                            ...
                            <a href="{{ url ('barang/create') }}" class="ti-btn ti-btn-info-full">
                                        Tambah
                                        <i class="fe fe-arrow-right rtl:rotate-180 ms-2 rtl:ms-0 align-middle"></i>
                                    </a>
                                   
                                    <a href="{{ route ('barang.invoice') }}" class="ti-btn ti-btn-secondary-full">
                                        invoice
                                        <i class="fe fe-arrow-right rtl:rotate-180 ms-2 rtl:ms-0 align-middle"></i>
                                    </a>
                                    ...
                                    <table class="table">
                                        <thead>
                                            ...
                                            <th scope="col" class="text-start">No</th>
                                                ...
                                                <th scope="col" class="text-start">Ruangan</th>
                                                <th scope="col" class="text-start">Jumlah_barang</th>
                                        ...
                                        @foreach ($barang as $key =>$item)
                                            ...
                                            <td>{{ $item->nama }}</td>  
                                            <td>{{ $item->kategori ? $item->kategori->nama: 'Tidak punya kategori' }}</td>
                                            <td>{{ $item->satuan ? $item->satuan->nama: 'Tidak punya satuan' }}</td>
                                            <td>{{ $item->ruangan ? $item->ruangan->nama: 'Tidak punya ruangan' }}</td>
                                            <td>{{ $item->jumlah_barang }}</td>
                                          
                                                <td>
                                                    <div class="hstack flex gap-3 text-[.9375rem]">
                                                    <a aria-label="anchor" href="{{url('barang/'.$item->id.'/edit')}}"
