                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="xl:col-span-12 col-span-12">
                        <div class="box custom-box">
                            ...
                            <a href="{{ url ('merk/create') }}" class="ti-btn ti-btn-info-full">
                                        Tambah
                                        <i class="fe fe-arrow-right rtl:rotate-180 ms-2 rtl:ms-0 align-middle"></i>
                                    </a>
                                   
                                    <a href="{{ route ('merk.invoice') }}" class="ti-btn ti-btn-secondary-full">
                                        invoice
                                        <i class="fe fe-arrow-right rtl:rotate-180 ms-2 rtl:ms-0 align-middle"></i>
                                    </a>
                                        ...
                                        @foreach ($merk as $key =>$item)
                                            ...
                                            <td>{{ $item->nama_merk }}</td>  
                                                ...
                                                <td>
                                                    ...
                                                    <a aria-label="anchor" href="{{url('merk/'.$item->id_merk.'/edit')}}"
                                                            class="ti-btn ti-btn-icon ti-btn-sm ti-btn-success-full"><i
                                                                class="ri-edit-line"></i></a>
                                                                <form action="{{ url('merk', $item->id_merk) }}" method="POST">
                                                                  @csrf
                                                                  @method('DELETE')
