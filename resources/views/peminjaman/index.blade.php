...
@section('content')
          ...
          <div class="main-content">
                ...
                <div class="md:flex block items-center justify-between mb-6 mt-[2rem]  page-header-breadcrumb">
                  <div class="my-auto">
                    <h5 class="page-title text-[1.3125rem] font-medium text-defaulttextcolor mb-0">peminjaman</h5>
                    <nav>
                      <ol class="flex items-center whitespace-nowrap min-w-0">
                        <li class="text-[12px]"> <a class="flex items-center text-primary hover:text-primary"
                            href="javascript:void(0);"> peminjaman <i
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="xl:col-span-12 col-span-12">
                        <div class="box custom-box">
                            ...
                            <a href="{{ url ('peminjaman/create') }}" class="ti-btn ti-btn-info-full">
                                        Tambah
                                        <i class="fe fe-arrow-right rtl:rotate-180 ms-2 rtl:ms-0 align-middle"></i>
                                    </a>
                                   
                                    <a href="{{ route ('peminjaman.invoice') }}" class="ti-btn ti-btn-secondary-full">
                                        invoice
                                        <i class="fe fe-arrow-right rtl:rotate-180 ms-2 rtl:ms-0 align-middle"></i>
                                    </a>
                                    ...
                                    <table class="table">
                                        <thead>
                                            ...
                                            <th scope="col" class="text-start">No</th>
                                                <th scope="col" class="text-start">Kode peminjaman</th>
                                                <th scope="col" class="text-start">Nama Peminjam</th>
                                                ...
                                                <th scope="col" class="text-start">Status peminjaman</th>
                                        ...
                                        @foreach ($peminjaman as $key =>$item)
                                            ...
                                            <td>{{ $item->barang ? $item->barang->nama: 'Tidak ada barang' }}</td>
                                            <td>{{ $item->tanggal_peminjaman }}</td>
                                            <td>{{ $item->tanggal_pengembalian ? $item->tanggal_pengembalian : 'Tanggal belum diatur' }}</td>
                                            <td>{{ $item->status_peminjaman }}</td>
                                          
                                                <td>
                                                    <div class="hstack flex gap-3 text-[.9375rem]">
                                                    <a aria-label="anchor" href="{{url('peminjaman/'.$item->id.'/edit')}}"
