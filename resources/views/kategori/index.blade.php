                    ...
                    <nav>
                      <ol class="flex items-center whitespace-nowrap min-w-0">
                        <li class="text-[12px]"> <a class="flex items-center text-primary hover:text-primary"
                            href="javascript:void(0);"> kategori <i
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="xl:col-span-12 col-span-12">
                        <div class="box custom-box">
                            ...
                            <a href="{{ url ('kategori/create') }}" class="ti-btn ti-btn-info-full">
                                        Tambah
                                        <i class="fe fe-arrow-right rtl:rotate-180 ms-2 rtl:ms-0 align-middle"></i>
                                    </a>
                                   
                                    <a href="{{ route ('kategori.invoice') }}" class="ti-btn ti-btn-secondary-full">
                                        invoice
                                        <i class="fe fe-arrow-right rtl:rotate-180 ms-2 rtl:ms-0 align-middle"></i>
                                    </a>
                                        ...
                                        @foreach ($kategori as $key =>$item)
                                            ...
                                            <td>{{ $item->keterangan }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a aria-label="anchor" href="{{url('kategori/'.$item->id_kategori.'/edit')}}"
                                                            class="ti-btn ti-btn-icon ti-btn-sm ti-btn-success-full"><i
                                                                class="ri-edit-line"></i></a>
                                                                <form action="{{ url('kategori', $item->id_kategori) }}" method="POST">
                                                                  @csrf
                                                                  @method('DELETE')
